...
def get_medical_records(request):
    ...
    # Convert QuerySet to List of Dictionaries (Manual Serialization)
    medical_records_list = [
        {
            ...
            'attendingstaff': f"{record.attendingstaff.first_name} {record.attendingstaff.last_name} {record.attendingstaff.suffix if record.attendingstaff.suffix else ''}".strip() if record.attendingstaff else "Unknown",            'timetreatment': record.timetreatment,
